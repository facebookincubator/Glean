...
struct ConstantLookup : public Lookup {
  ...
  Id firstFreeId() const override { return Id::lowest()+1; }
...
template<typename F> void concurrently(F&& f) {
...
void CacheTest::typeById_miss(size_t miss, size_t shards) {
  setup(ConstantLookup(), [&](auto& opts){
    opts.shards = shards;
  });
...
TEST_F(CacheTest, typeById_miss_100_8) { typeById_miss(10, 8); }
TEST_F(CacheTest, typeById_miss_90_8) { typeById_miss(9, 8); }
TEST_F(CacheTest, typeById_miss_50_8) { typeById_miss(5, 8); }
TEST_F(CacheTest, typeById_miss_10_8) { typeById_miss(1, 8); }

TEST_F(CacheTest, typeById_miss_100_2) { typeById_miss(10, 2); }
TEST_F(CacheTest, typeById_miss_90_2) { typeById_miss(9, 2); }
TEST_F(CacheTest, typeById_miss_50_2) { typeById_miss(5, 2); }
TEST_F(CacheTest, typeById_miss_10_2) { typeById_miss(1, 2); }

TEST_F(CacheTest, typeById_miss_100_0) { typeById_miss(10, 0); }
TEST_F(CacheTest, typeById_miss_90_0) { typeById_miss(9, 0); }
TEST_F(CacheTest, typeById_miss_50_0) { typeById_miss(5, 0); }
TEST_F(CacheTest, typeById_miss_10_0) { typeById_miss(1, 0); }
