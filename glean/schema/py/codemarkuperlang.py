...
class CodemarkupErlangErlangEntityInfo(GleanSchemaPredicate):
  ...
  def build_angle(key: Union[int, bool, str, Tuple[()], List[Tuple[str, str]]]) -> Tuple[str, Struct]:
    ...
    return f"codemarkup.erlang.ErlangEntityInfo.2 { concatenateFields(key) }", ErlangErlangEntityInfo
...
class CodemarkupErlangErlangEntityLocation(GleanSchemaPredicate):
  ...
  def build_angle(key: Union[int, bool, str, Tuple[()], List[Tuple[str, str]]]) -> Tuple[str, Struct]:
    ...
    return f"codemarkup.erlang.ErlangEntityLocation.2 { concatenateFields(key) }", ErlangErlangEntityLocation
...
class CodemarkupErlangErlangResolveLocation(GleanSchemaPredicate):
  ...
  def build_angle(key: Union[int, bool, str, Tuple[()], List[Tuple[str, str]]]) -> Tuple[str, Struct]:
    ...
    return f"codemarkup.erlang.ErlangResolveLocation.2 { concatenateFields(key) }", ErlangErlangResolveLocation
...
class CodemarkupErlangErlangFileEntityXRefLocations(GleanSchemaPredicate):
  ...
  def build_angle(key: Union[int, bool, str, Tuple[()], List[Tuple[str, str]]]) -> Tuple[str, Struct]:
    ...
    return f"codemarkup.erlang.ErlangFileEntityXRefLocations.2 { concatenateFields(key) }", ErlangErlangFileEntityXRefLocations
...
class CodemarkupErlangErlangEntityUses(GleanSchemaPredicate):
  ...
  def build_angle(key: Union[int, bool, str, Tuple[()], List[Tuple[str, str]]]) -> Tuple[str, Struct]:
    ...
    return f"codemarkup.erlang.ErlangEntityUses.2 { concatenateFields(key) }", ErlangErlangEntityUses
...
class CodemarkupErlangErlangEntityKind(GleanSchemaPredicate):
  ...
  def build_angle(key: Union[int, bool, str, Tuple[()], List[Tuple[str, str]]]) -> Tuple[str, Struct]:
    ...
    return f"codemarkup.erlang.ErlangEntityKind.2 { concatenateFields(key) }", ErlangErlangEntityKind
