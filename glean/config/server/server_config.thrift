// @generated SignedSource<<fc61fca05abdd65792d05b77d003d8bb>>
...
struct Config {
  ...
  // When true, backups are made from tarfiles of the raw DB. When
  // false, RocksDB's backup is used to produce the files that are
  // then rolled into a tarfile.
  32: bool backup_plain_tarfile = false;
}
