// @generated SignedSource<<be28a4201dfa915cf261c95cb9adb801>>
...
struct Retention {
  ...
  // If set, only the N most recent complete DBs per UTC calendar day
  // are eligible for retention. Combine with `retain_at_least`, `retain_at_most` and
  // `delete_if_older` to bound the total number of DBs kept on the server.
