...
/*
 * [FB]
 * The open source version of TSimpleJSONProtocol encodes booleans as a 1 or 0.
 * However this isn't valid JSON as booleans must be encoded as true or false.
 * This is a forked version of TSimpleJSONProtocol which fixes that.
 *
 * In JSON there must be a ':' character between a key and a value. To add a
 * colon to the output, you have to call writeContext._write(). However
 * writeContext is a private member variable, which is why this class was forked
 * instead of being subclassed. There is probably a better way to get this to
 * work, but this is the fastest way forward for now.
 */
