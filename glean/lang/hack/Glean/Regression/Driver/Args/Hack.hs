  ...
  where
    ...
    hhvmConfig = unwords
      $ map
          ...
          "symbolindex_search_provider=NoIndex", "use_mini_state=true",
          "lazy_decl=true", "lazy_parse=true", "lazy_init2=true",
          "enable_enum_classes=true", "enable_enum_supertyping=true"]
